...
(function() {
    ...
    var toolkit = {
        ...
        div#spinner{display : block;position : fixed;z-index: 100;background-color: #dedede; opacity: 0.8; background-repeat : no-repeat;background-position : center;left : 0;
