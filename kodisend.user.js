...
(function(doc, undef) {
    ...
    let app = function() {
        ...
        styles += `
            ...
            .kodisend-settings .settings{position: absolute; top:33%; left: 25%; width:50%; min-height: 33%;}
        ...
        let setevents = {
            ...
            hostname: {
                ...
                change(e) {
                    return setevents.hostname.keyup.call(this, e);
                }
            },
            port: {
                keyup(e) {
        ...
        this.start = function(toolbar) {
            if (typeof toolbar === "object") {
                ...
                ol.toolbar.insertBefore(this.button, ol.clipboard);
    ...
    onDocEnd(function() {
        ...
        let w = setInterval(function() {
            if (typeof oltoolbar === "object" && typeof oltoolbar.toolbar !== "undefined") {
                console.debug(scriptname, 'started');
                clearInterval(w);
                w = undef;
                kodisend.start(oltoolbar);
            }
        });
        setTimeout(function() {
            if (w !== undef) {
