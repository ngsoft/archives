...
(function() {
    ...
    var vikisubs = {
        ...
        //mobile counterpart
        mobile: `<li class="navbar-divider"></li><li class="navbar-item"><a href="#">Subtitles</a><ul class="navbar-expanded-secondary"></ul></li>`,
        //contains the links
        ...
        addsub: function(src, lang, percent) {
            if (typeof vikisubs.countries[lang] !== 'undefined') {
                ...
                vikisubs.mobile.find('ul').append(link.clone());
            }
        },
        //initialize the blackscript
        run: function() {
            $(document).ready(function() {
                $('body').append(vikisubs.css);
        ...
        init: function() {
            var interval = setInterval(function() {
                if (typeof $ !== 'undefined' && typeof subtitles !== 'undefined') {
                    vikisubs.run();
    ...
    window.addEventListener("load", vikisubs.init, false);
}());
